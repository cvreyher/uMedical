  ...
  try {
    ...
    return (
      <p className="text-sm text-muted-foreground text-center py-4">
        Statistiken konnten nicht geladen werden - API nicht erreichbar.
      </p>
    )
  }
}
...
async function RecentEventsDisplay() {
  try {
    ...
    return (
      <p className="text-sm text-muted-foreground text-center py-12">
        Events konnten nicht geladen werden - API nicht erreichbar.
      </p>
    )
  }
}
...
async function ChartsDisplay() {
  try {
    ...
    return (
      <p className="text-sm text-muted-foreground text-center py-12">
        Diagramme konnten nicht geladen werden - API nicht erreichbar.
      </p>
    )
  }
}
...
async function ApprovalsPerYearChart() {
  try {
    ...
    return (
      <p className="text-sm text-muted-foreground text-center py-12">
        Zulassungsstatistik konnte nicht geladen werden - API nicht erreichbar.
      </p>
    )
  }
}
...
async function HighlightsSection() {
  try {
    ...
    return (
      <p className="text-sm text-muted-foreground text-center py-12">
        Highlights konnten nicht geladen werden - API nicht erreichbar.
      </p>
    )
  }
}
